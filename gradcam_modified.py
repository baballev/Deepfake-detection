...
if __name__ == '__main__':
    ...
    grad_cam = GradCam(model=model, feature_module=model.layer4, \
                       target_layer_names=["2"], use_cuda=args.use_cuda) # ICI on a de la chance car c'est les meme noms quelques soient le resnet utilisé mais ça coute de rien de checker le nom des couches avec un print(model)
